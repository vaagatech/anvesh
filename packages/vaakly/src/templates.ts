/**
 * Vaakly message codes and templates — clear user summaries + log lines.
 ...
 * Prefer singular nouns in templates; `correctSummary` fixes plurals.
 */
export const TEMPLATES: Record<MessageCode, MessageTemplate> = {
  OK_SEARCH: {
    user: "Search completed. Found {total} matching document in {tookMs}ms.",
